...
const expressForApi = require('express');



const  APIServer = expressForApi()

// @ts-ignore
const API_PORT = process.env.API_PORT ?? 3010;


APIServer.get('/', (req: any, res: { send: (arg0: string) => any; }) => res.send('api server working'));
// eslint-disable-next-line no-console
APIServer.listen(API_PORT,  () => console.log(`API Sever listening on port ${API_PORT}!`));
